                                            ...
                                            common::uint8_t* internetprotocolPayload, common::uint32_t size)
{
    ...
    switch(msg->type)
    {
        ...
        case 0:
            printf("ping response from "); printf(Convert::itoa(srcIP_BE & 0xFF));
            printf("."); printf(Convert::itoa((srcIP_BE >> 8) & 0xFF));
            printf("."); printf(Convert::itoa((srcIP_BE >> 16) & 0xFF));
            printf("."); printf(Convert::itoa((srcIP_BE >> 24) & 0xFF));
            printf("\n");
            break;
